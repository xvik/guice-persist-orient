...
[OrientDB](https://orientdb.dev/) is document, graph and object database (see [intro](https://www.youtube.com/watch?v=o_7NCiTLVis).
...
----------|-------|------
3.2 | 7.0.0 | [5.0.0](http://xvik.github.io/guice-persist-orient/5.0.0)
