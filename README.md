...
* Support for [document](https://orientdb.dev/docs/3.1.x/java/Document-Database.html), [object](https://orientdb.dev/docs/3.1.x/java/Object-Database.html) and
[graph](https://orientdb.dev/docs/3.1.x/java/Graph-Database-Tinkerpop.html) databases
