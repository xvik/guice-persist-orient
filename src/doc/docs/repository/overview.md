...
[Function](https://orientdb.com/docs/3.0.x/admin/Functions.html) call:
...
[Pagination](https://orientdb.com/docs/3.0.x/sql/Pagination.html):
...
[Fetch plan](https://orientdb.com/docs/3.0.x/java/Fetching-Strategies.html) parameter:
...
[Sql](https://orientdb.com/docs/3.0.x/sql/SQL-batch.html) script:
...
[Js](https://orientdb.com/docs/3.0.x/js/Javascript-Command.html) script:
...
[Async](https://orientdb.com/docs/3.0.x/java/Document-API-Documents.html#asynchronous-queries) query:
...
[Live](https://orientdb.com/docs/3.0.x/java/Live-Query.html) query:
