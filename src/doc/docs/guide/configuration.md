...
See [orient documentation](https://orientdb.dev/docs/3.2.x/datamodeling/Concepts.html#database-url) for supported db types.
In short:
...
Read about [all configuration options](https://orientdb.dev/docs/3.2.x/admin/Configuration.html)


## Default transaction type

Default [transactions](https://orientdb.dev/docs/3.2.x/internals/Transactions.html) configuration may be specified as additional module parameter.
By default, [OPTIMISTIC transactions](https://orientdb.dev/docs/3.2.x/internals/Transactions.html#optimistic-transaction) used (use optimistic locking based on object version, same way as hibernate optimistic locking). 
...
You may need to use orient [custom types](https://orientdb.dev/docs/3.2.x/java/Object-2-Record-Java-Binding.html#custom-types)
