...
See [orient documentation](https://orientdb.dev/docs/3.1.x/datamodeling/Concepts.html#database-url) for supported db types.
In short:
...
Read about [all configuration options](https://orientdb.dev/docs/3.1.x/admin/Configuration.html)


## Default transaction type

Default [transactions](https://orientdb.dev/docs/3.1.x/internals/Transactions.html) configuration may be specified as additional module parameter.
By default, [OPTIMISTIC transactions](https://orientdb.dev/docs/3.1.x/internals/Transactions.html#optimistic-transaction) used (use optimistic locking based on object version, same way as hibernate optimistic locking). 
