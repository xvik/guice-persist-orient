...
See [orient object mapping documentation](https://orientdb.dev/docs/3.1.x/java/Object-2-Record-Java-Binding.html) for object mapping
 ([and general object database page](https://orientdb.dev/docs/3.1.x/java/Object-Database.html)).
...
[orient studio](https://orientdb.dev/docs/3.1.x/studio/)).
...
* JPA annotations can be used to [define cascades](https://orientdb.dev/docs/3.1.x/java/Object-Database.html)
...
* [Classes](https://orientdb.dev/docs/3.1.x/sql/SQL-Alter-Class.html)
* [Properties](https://orientdb.dev/docs/3.1.x/sql/SQL-Alter-Property.html)
* [Indexes](https://orientdb.dev/docs/3.1.x/indexing/Indexes.html) ([create index](https://orientdb.dev/docs/3.1.x/sql/SQL-Create-Index.html))
