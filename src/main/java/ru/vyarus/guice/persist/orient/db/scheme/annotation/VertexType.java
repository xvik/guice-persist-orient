...
/**
 * Annotate model class to create scheme which extends V and so allowed for creation from graph api (as vertex).
 * Keep track of object hierarchy: if annotated entity extend some other entity (e.g. VersionedEntity) then this
 * base class must extend vertex type (V) and initializer will try to do it.
