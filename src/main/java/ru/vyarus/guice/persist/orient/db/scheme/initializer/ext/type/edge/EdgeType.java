 ...
 * @see <a href="https://orientdb.dev/docs/3.2.x/sql/SQL-Alter-Class.html">alter docs</a>
 * @see <a href="https://orientdb.dev/docs/3.2.x/sql/SQL-Create-Class.html">create docs</a>
 * @since 03.08.2014
 */
@Documented
@Target(TYPE)
