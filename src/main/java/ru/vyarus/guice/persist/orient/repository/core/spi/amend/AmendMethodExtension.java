 ...
 * <p>Amend extensions are driven by annotations annotated with
 * {@link ru.vyarus.guice.persist.orient.repository.core.spi.amend.AmendMethod}.</p>
 * <p>For example, if query and parameters need to be logged for some query extension method. To add logging,
 * new amend annotation extension should be defined (e.g. @LogQueries). Annotation extension must implement
 * amend extension interface.</p>
