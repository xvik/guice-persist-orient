 ...
 * <p>Note that default converter checks result compatibility with actual result object and performs
 * collection type conversion (if specific collection type requested in method annotation, e.g.
 * {@link ru.vyarus.guice.persist.orient.repository.command.query.Query} support it).</p>
 *
