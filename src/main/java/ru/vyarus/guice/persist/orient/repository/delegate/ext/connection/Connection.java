 ...
 * <p>Resolved connection will be passed to delegate method. For example, it may be used to
 ...
 * ({@link com.orientechnologies.orient.core.db.ODatabaseInternal}).</p>
 * <p>{@link ru.vyarus.guice.persist.orient.repository.delegate.Delegate} annotation support connection hint,
 * which may help selecting correct connection type.</p>
 *
