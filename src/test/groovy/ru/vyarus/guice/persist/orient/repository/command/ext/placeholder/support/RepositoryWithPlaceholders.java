...
import ru.vyarus.guice.persist.orient.repository.command.ext.placeholder.PlaceholderValues;
import ru.vyarus.guice.persist.orient.repository.command.ext.placeholder.Placeholders;
...
public interface RepositoryWithPlaceholders {
    ...
    @Query("select from Model where ${field} = ? and ${field2} = ?")
    @PlaceholderValues(name = "field", values = {"name", "nick"})
